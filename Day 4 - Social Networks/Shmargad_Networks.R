...
# Test non-existent account (THIS WILL GENERATE AN ERROR)
...
# Print objects that store tweet information
posts
text
check
people
...
# Remove duplicates from list of accounts
dim(people)
people <- unique(people)
dim(people)

# Compare total retweets to retweets obtained
check
